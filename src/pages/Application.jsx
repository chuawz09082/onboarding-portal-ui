...
function Application() {
  ...
  // Breadcrumb items for application page
  const breadcrumbItems = [{ label: 'Applications', href: '/application' }];
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="flex flex-wrap gap-4 mb-6">
          ...
          <div className="relative flex-1 min-w-64">
            <input
              type="text"
              placeholder="Search by employee ID, comment, or AWF ID..."
              value={searchTerm}
        ...
        {/* Application List with action button */}
